...
Icônes mathématiques par Freepik (<http://www.flaticon.com/packs/mathbert-mathematics>)'''
        ...
        translate["tips_search_text"] = "● Vous n’êtes pas obligé de taper le nom d’une carte en entier pour la trouver.\n\n● La base de données contient les noms des cartes dans toutes les langues dans lesquelles elles ont été éditées. Vous pouvez donc directement taper les noms non-anglais des cartes dans la recherche par nom.\n\n● Tous les champs de recherche (à l’exception du champ '" + translate["quantity_card_coll"] + "') supportent une utilisation limitée des opérateurs logiques ':" + translate["operator_and"] + ":' et ':" + translate["operator_or"] + ":'.\n\n● Dans tous les champs de recherche (sauf les champs '" + translate["cmc_ad"] + "', '" + translate["column_power"] + "', '" + translate["column_toughness"] + "', '" + translate["loyalty_ad"] + "' et '" + translate["quantity_card_coll"] + "'), ajouter un '!' devant le terme de la recherche va rechercher l'opposé.\n\n● Les champs '" + translate["text_ad"] + "', '" + translate["flavor_ad"] + "', '" + translate["condition_coll"] + "', '" + translate["lang_coll"] + "', '" + translate["loaned_coll"] + "', '" + translate["comment_coll"] + "' et '" + translate["in_deck"] + "' supportent l’utilisation du caractère ‘¤’ (ou ‘ø’) pour indiquer une valeur nulle. Par exemple, indiquer 'goblin' dans le champ '" + translate["type_ad"] + "' et '¤' dans le champ '" + translate["text_ad"] + "' cherchera tous les gobelins sans texte. À noter que l'opposé fonctionne avec la valeur nulle ('goblin' dans le champ '" + translate["type_ad"] + "' et '!¤' dans le champ '" + translate["text_ad"] + "' cherchera tous les gobelins avec texte).\n\n● Dans le champ '" + translate["name_ad"] + "', il est possible d’indiquer '//' pour chercher dans les cartes ‘splitées’, '<>' pour chercher dans les cartes inversées, '||' pour chercher dans les cartes recto-versos et '~~' pour chercher dans les cartes avec l'assimilation.\n\n● Le champ '" + translate["column_rarity"] + "' accepte les valeurs suivantes :\n\n● Les valeurs saisies dans le champ '" + translate["manacost_eg_ad"] + "' doivent être entourées par les crochets '{' et '}'.\n\n● Le champ '" + translate["colors_ad"] + "' accepte également les noms anglais des couleurs, ainsi que leur première lettre.\n\n● Le champ '" + translate["type_ad"] + "' accepte également les valeurs suivantes :\n\n● Le champ '" + translate["add_condition"] + "' supporte les valeurs suivantes :"
        #########################
        return(translate)
